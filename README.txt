...
■更新履歴
2026/07/31　Ver 0.1.2.05
タイムシフト機能修正ほか
- メイン画面に録画終了時間入力用のTextBox追加
- 録画開始時間・終了時間をHH:MM:SS で入力するように修正
- 時間指定されている場合はコメントを終了時間前のみ取得するよう修正
- sqlite3ファイルの変換時、時間指定されていたらその時間で出力するように修正
- 録画時に先に動画取得が終わってもコメント取得終了しないように修正
- 外部ファイル録画後のコメントファイルのナンバーがずれるのを修正
- 動画のみ/コメントのみの場合録画終了しない場合があるのを修正
コメント機能修正
- proto定義ファイルをv2026.629.180145 に更新
外部プログラム機能修正
- アプリケーションのプロパティ設定に変数ExtFile、ExtCommand他 追加
- オプションに外部プログラム設定を追加
